...
#if MS_C | TURBO_C | HIGH_C | GNU_C                  /* ANSI compilers              */
#define ANSI 1
...
#if DR_C | LASER_C | LATTICE_C | MW_C | HIGH_C | PCC | XL_C | GNU_C
#define cdecl
#define pascal
#endif
