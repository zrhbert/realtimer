...
#define WI_DLCLOSE  0x0008                /* Flag für "Dialog-Fenster schließen" */
...
#define WI_MOUSE    0x0080                /* Flag für "Eigene Mausform" */
#define WI_NOSCROLL 0x0100                /* Flag für "Update statt Scrolling */
#define WI_MODAL    0x0200                /* Flag für "Modales Dialog-Fenster" */
#define WI_MODELESS 0x0400                /* Flag für "Nicht-Modales Dialog-Fenster" */
#define WI_CURSKEYS 0x0800                /* Flag für "Cursor Tasten für Scrolling" */
#define WI_MNSCROLL 0x1000                /* Flag für "Scrollbare Menüzeile */
#define WI_TOPMENU  0x2000                /* Flag für "Menüzeile soll nur oben funktionieren */
#define WI_JUNK	  0x4000						/* Flag für "Müll im Fenster, Scrollbereich neu aufbauen */

#define DRAG_OK     ( 0)                  /* Drag-Code für "Funktion OK" */
#define DRAG_SWIND  (-1)                  /* Drag-Code für "Gleiches Fenster" */
#define DRAG_SCLASS (-2)                  /* Drag-Code für "Gleiche Art" */
#define DRAG_NOWIND (-3)                  /* Drag-Code für "Ungültiges Fenster" */
#define DRAG_NORCVR (-4)                  /* Drag-Code für "Kein Empfänger" */
#define DRAG_NOACTN (-5)                  /* Drag-Code für "Keine Empfänger-Aktion */

#define DO_UNDO     0                     /* Code für "Undo" */
#define DO_CUT      1                     /* Code für "Cut" */
#define DO_COPY     2                     /* Code für "Copy" */
#define DO_PASTE    3                     /* Code für "Paste" */
#define DO_CLEAR    4                     /* Code für "Clear" */
#define DO_SELALL   5                     /* Code für "Select all" */
...
#define OBJ_OPEN    0                     /* Code für "Objekt öffnen" */
#define OBJ_INFO    1                     /* Code für "Info von Objekt" */
#define OBJ_HELP    2                     /* Code für "Hilfe von Objekt" */
...
#define SRCH_SUB    0x04                  /* Search-Code für Unterklasse */
...
typedef struct window
{
  ...
  LONG    count;                          /* Zähler für Millisekunden */
  ...
  OBJECT  *menu;                          /* Menüzeile für Fenster */
  WORD    first_menu;                     /* Erstes angezeigtes Menü */
  VOID 	 *module;								/* Modulzeiger für RTM-Module */
  LIST_P	 dispobjs;								/* Eine Liste von Display-Objekten */
  VOID    (*updt_menu) _((WINDOWP window));             /* Menü auf neuen Stand bringen */
  VOID    (*hndl_menu) _((WINDOWP window, WORD title, WORD item)); /* Menü-Handler */
  BOOLEAN (*test)      _((WINDOWP window, WORD action));/* Test vor einer Aktion */
  VOID    (*open)      _((WINDOWP window));             /* Aktion vor dem Öffnen */
  VOID    (*close)     _((WINDOWP window));             /* Aktion nach dem Schließen */
  VOID    (*delete)    _((WINDOWP window));             /* Aktion nach dem Löschen */
...
typedef struct
{
  ...
  VOID    *itemlist;            /* Liste der Structs aller Einträge */
  SIZE_T  itemsize;             /* Größe eines Elements */
  BOOLEAN indirect;             /* Elemente sind Zeiger auf Zeichenketten */
  WORD    num_items;            /* Anzahl verfügbarer Einträge */
  WORD    vis_items;            /* Anzahl sichtbarer Einträge  */
  ...
  WORD    items;                /* Objektnummer der Box mit Einträgen */
