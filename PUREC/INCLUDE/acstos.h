...
/* Konstanten f�r 'mode' der Struktur XATTR */
...
/* Attribute f�r Fcreate/Fsfirst/Fsnext: */
...
/* Maske f�r die Anzahl der Planes */
#define NUMCOLS           7

/******************************************************************************/

/* Konstanten f�r PAMsNet */
#define NLOCK    1
#define NUNLOCK  0
...
/* Abw�rtskompatibilit�t mit PureC */
...
/* Struktur f�r Fdatime gem. Kompendium */
typedef struct
{
	uint16 hour:5;
	uint16 minute:6;
...
/* F�r die Shared-Libraries ab MagiC 6 */
...
/* Ein paar Datentypen f�r den MagiCMac-Cookie */
typedef char	**Handle;
typedef void	PixMap;
...
struct MgMcCookie
{
	...
	int16				size;					/* Gr��e der Struktur in Bytes         */
	int32				flags1;				/* verschiedene Flags:                 */
												/*                                     */
												/* Bit-0: 640*400-Emulation aktiv      */
												/* Bit-1: Rechts-Shift m�glich         */
												/* Bit-2: 2-Tasten-Maus                */
	...
	VoidProcPtr		intrLock;			/* Erh�ht Interrupt-Semaphore-Z�hler   */
	VoidProcPtr		intrUnlock;			/* Erniedrigt Inter.-Semaphore-Z�hler  */
	VoidProcPtr		callMacContext;	/* F�hrt Routine im Mac-Kontext aus;   */
												/* Proc-Adr auf Stack.                 */
												/*                                     */
												/* Achtung: Die RegisterD0-D2/A0/A1    */
												/* A5 und A7 werden zerst�rt.          */
	
	char				*atariZeroPage;	/* Zeiger auf Atari-Speicherbereich    */
												/* $0-$800 im Macintosh-Adre�raum      */
	...
	char				*auxOutName;			/* Pascal-String f�r AUX-Ausg.-Device  */
	char				*auxInName;			/* Pascal-String f�r AUX-Eing.-Device  */
...
/* Struktur f�r Variablen-Gruppen */
typedef struct
{
...
/* Liefert Maske f�r Mxalloc() - siehe Maus.Computer.Atari.Programmieren */
int16 Mxmask( void );
...
/*    >0: MagiC vorhanden und MagiC-AES aktiv, der R�ck- */
